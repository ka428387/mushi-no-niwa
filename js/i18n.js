...
ja:{
  ...
  'field.hint':'灯りを動かして声のする方へ。<b>急いで近づくと鳴きやみます</b>。虫が光ったら、タップで網をふります。',
  'field.stat':'{area}　今夜は{moon}',
  'garden.empty':'まだ庭に虫がいません。<br>「探す」で虫をつかまえてきましょう。',
  'garden.hint':'虫をドラッグすると、聞こえる方向と遠さが変わります。同じ種類を近くに置くと<b>交互に鳴き交わします</b>。',
  ...
  'wx.title':'天気','wx.clear':'晴れ','wx.light':'小雨',
...
en:{
  ...
  'field.hint':'Move the lantern toward the voices. <b>Come too close too fast, and they fall silent.</b> When an insect glints, tap to swing your net.',
  'field.stat':'{area} · Tonight: {moon}',
  'garden.empty':'No insects in your garden yet.<br>Go to “Search” and catch some.',
  'garden.hint':'Drag an insect to change where you hear it and how far away. Two of the same kind placed close together <b>sing in turns</b>.',
  ...
  'wx.title':'Weather','wx.clear':'Clear','wx.light':'Light rain',
  ...
  'zukan.unknown':'An insect you have not met yet. Its song is heard in {areas}.','zukan.areaSep':', ',
...
const SPECIES_TEXT={
  ...
  emma:{ja:{name:'エンマコオロギ',voice:'コロコロリー',desc:'日本で最も大きなコオロギの仲間。顔つきが閻魔さまに似ていることから名がついた。草むらや畑のすみでよく鳴いている。'},
    en:{name:'Enma-kōrogi',common:'Emma field cricket',voice:'koro-koro-ree',desc:'The largest field cricket in Japan, named after Enma, the stern king of the underworld, because its face is said to resemble his. It sings in grassy corners and at the edges of fields.'}},
  ...
  kutsuwa:{ja:{name:'クツワムシ',voice:'ガチャガチャ',desc:'馬の口につける轡（くつわ）が鳴る音に似ていることから名がついた。大型のキリギリスの仲間で、声もにぎやか。'},
    en:{name:'Kutsuwamushi',common:'Bridle katydid',voice:'gacha-gacha',desc:'Named because its song sounds like the jingling of a horse’s bridle bit (kutsuwa). A large katydid with a lively, clattering song.'}},
  ...
  kusahibari:{ja:{name:'クサヒバリ',voice:'フィリリリリ…',desc:'体長7mmほどの小さなコオロギの仲間。ヒバリのように澄んだ声で、昼間にも鳴く。とても臆病で、近づくとすぐ黙る。'},
    en:{name:'Kusahibari',common:'Grass lark',voice:'fi-ri-ri-ri…',desc:'A tiny cricket about 7 mm long, with a clear, trilling song like a skylark’s. It sings even in the daytime. Very shy, it falls silent as soon as you come near.'}},
  ...
  aomatsu:{ja:{name:'アオマツムシ',voice:'リーリーリー',desc:'明治時代に日本に入ったとされる外来の虫。街路樹や公園の木の上で、にぎやかに鳴く。いまでは都会の秋の音になっている。'},
    en:{name:'Aomatsumushi',common:'Green pine cricket',voice:'ree-ree-ree',desc:'An introduced insect thought to have arrived in Japan in the Meiji era (late 19th century). It sings loudly from street trees and park trees, and has become the sound of autumn in the city.'}},
  kumasuzu:{ja:{name:'クマスズムシ',voice:'ジジジジ…',desc:'体長7mmほどの黒い小さな虫。名前にスズムシとあるが、スズムシとは別の仲間。落ち葉の間など地面の近くで、細かく鳴く。'},
    en:{name:'Kumasuzumushi',common:'Little black cricket',voice:'ji-ji-ji-ji…',desc:'A small black cricket about 7 mm long. Despite “suzumushi” in its name, it is not a bell cricket. It sings a fine, buzzing song close to the ground, among fallen leaves.'}},
  tsuyumushi:{ja:{name:'ツユムシ',voice:'チッ…チキチキチキ',desc:'細長い体で、よく飛ぶ。声は小さく控えめで、つぶやくように鳴く。ほかの虫の声のすき間から聞こえてくる。'},
    en:{name:'Tsuyumushi',common:'Dew katydid',voice:'chit… chiki-chiki-chiki',desc:'A slender katydid that flies well. Its song is soft and modest, like a murmur, drifting through the gaps between the other insects’ calls.'}},
  kayakiri:{ja:{name:'カヤキリ',voice:'ジーーーー',desc:'日本最大級のキリギリスの仲間。ススキなどカヤの草原で、太く長い声で鳴き続ける。ほかの虫の声を下から支える音。'},
    en:{name:'Kayakiri',common:'Thatch-grass katydid',voice:'jeeeeee',desc:'One of the largest katydids in Japan. It keeps up a thick, unbroken buzz in fields of thatch grass such as silver grass — a steady drone beneath all the other songs.'}},
};
